...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLectures,
        ...
        calcluateChapterTime,currency, backendurl, userData} = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className='absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-cyan-100/70 to-white pointer-events-none'></div>  
    ...
    <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
      ...
      <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students': 'student' }</p>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>GyaanVerse</span></p>
     ...
     {/* right column */}
     <div className='w-full md:w-auto max-w-course-card z-10 shadow-custom-card rounded overflow-hidden bg-white'>
    ...
    <div className='md:px-36 px-8 md:pt-30 pt-20'>Course not found.</div>
  )
}
